    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ flex: 1, overflowY: "auto", padding: "18px 20px 0" }}>
        ...
        <div style={{ marginTop: 16 }}>
          <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 800, fontSize: 12, color: MUTED, margin: "0 0 8px", textTransform: "uppercase", letterSpacing: .7 }}>Choose a starting Rule</p>
      ...
      <div style={{ padding: "14px 20px 18px", borderTop: `1px solid ${LINE}`, flexShrink: 0 }}>
        ...
        <button
          ...
          style={{
            ...
            border: `1px solid ${LINE}`, background: "transparent", color: GOLD,
            fontFamily: "Inter, sans-serif", fontWeight: 800, fontSize: 12.5,
            cursor: "pointer"
          }}
        >
          Create my own Rule instead
        </button>
        <p style={{ fontFamily: "Inter, sans-serif", fontSize: 11.5, color: MUTED, textAlign: "center", margin: "7px 0 0" }}>
          You can also change or create Rules anytime from Rules.
        </p>
      </div>
    </div>
  );
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                    ...
                    <span style={{ fontFamily: "Roboto, sans-serif", fontWeight: 800, fontSize: 13, color: over ? CORAL : INK, flexShrink: 0 }}>
                      {formatMoney(over ? c.spent : c.budget, currency)}
                    </span>
                  </div>
