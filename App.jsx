...
/* ---------------------------------------------------------
   ONBOARDING
--------------------------------------------------------- */
function Onboarding({ onFinish, rules, selectedRuleId, onSelectRule, currency, onCurrencyChange, onAddCurrency }) {
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
            <div style={{ minWidth: 0 }}>
              ...
              <p style={{ fontFamily: "Inter, sans-serif", fontSize: 10, color: MUTED, margin: "3px 0 0" }}>
                Suggested from your device settings
              </p>
            </div>
            <button
    ...
    <div style={{ paddingBottom: 24 }}>
      ...
      {!firstRun && (
        <div style={{ margin: "0 20px 12px", display: "flex", alignItems: "center", gap: 7, background: ACTIVE_TINT, border: `1px solid ${LINE}`, borderRadius: 10, padding: "8px 10px", color: MUTED }}>
          ...
          <span style={{ fontFamily: "Inter, sans-serif", fontSize: 11.5, lineHeight: 1.3 }}>Tap any category name or percentage to edit it.</span>
        </div>
      )}
