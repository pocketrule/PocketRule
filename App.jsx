  ...
  return (
    <section style={{ marginTop: 2, paddingBottom: 10 }}>
      ...
      <div className="pr-rise" style={{
        ...
        boxShadow: "0 18px 38px -24px rgba(31,168,74,0.55)"
      }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 13 }}>
        <div style={{ background: ACTIVE_TINT, borderRadius: 15, padding: "12px 8px", textAlign: "center" }}>
        ...
        <div style={{ background: INPUT_BG, borderRadius: 15, padding: "12px 8px", textAlign: "center" }}>
        ...
        <div style={{ background: "#F0ECF8", borderRadius: 15, padding: "12px 8px", textAlign: "center" }}>
          <p style={{ fontSize: 14, fontWeight: 800, margin: 0, color: INK }}>{Math.round(progress)}%</p>
