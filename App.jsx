    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ flex: 1, overflowY: "auto", padding: "18px 20px 0" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "Roboto, sans-serif", fontWeight: 600, fontSize: 12, color: GOLD, margin: "24px 0 8px" }}>QUICK SETUP</p>
        ...
        <div style={{ margin: "20px auto 0", maxWidth: 330, background: PAPER_DIM, border: `1px solid ${LINE}`, borderRadius: 16, padding: 12, boxShadow: SHADOW_CARD }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
            <div style={{ minWidth: 0 }}>
              <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, margin: "0 0 5px", textTransform: "uppercase", letterSpacing: 0.5, fontWeight: 800, textAlign: "left" }}>Your currency</p>
              ...
              <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, margin: "3px 0 0" }}>
            ...
            <button
              ...
              style={{ flexShrink: 0, display: "inline-flex", alignItems: "center", gap: 4, padding: "8px 10px", borderRadius: 10, border: `1px solid ${LINE}`, background: INPUT_BG, color: GOLD, cursor: "pointer", fontFamily: "Inter, sans-serif", fontWeight: 800, fontSize: 12 }}
            >
        ...
        <div style={{ marginTop: 16 }}>
          <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 800, fontSize: 12, color: MUTED, margin: "0 0 8px", textTransform: "uppercase", letterSpacing: .7 }}>Choose your starting Rule</p>
              ...
              return (
                <button key={r.id} onClick={() => onSelectRule(r.id)} style={{ width: "100%", textAlign: "left", display: "flex", alignItems: "center", gap: 12, padding: "13px 14px", borderRadius: 15, border: `1.5px solid ${active ? GOLD : LINE}`, background: active ? ACTIVE_TINT : PAPER_DIM, boxShadow: active ? "0 8px 20px -14px rgba(31,168,74,0.45)" : SHADOW_CARD, cursor: "pointer" }}>
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, margin: "3px 0 0", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, margin: "18px 0 8px", color: MUTED }}>
          ...
          <span style={{ fontFamily: "Inter, sans-serif", fontSize: 12 }}>Private by default. No bank access.</span>
        </div>
      </div>
    ...
    <section style={{ marginTop: 8, paddingBottom: 6 }}>
      <div className="pr-rise" style={{
        ...
        <div style={{ textAlign: "center", minWidth: 0 }}>
          ...
          <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, margin: 0, textTransform: "uppercase", letterSpacing: 0.9, fontWeight: 800 }}>Active plan</p>
          ...
          <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, margin: "3px 0 0" }}>{new Date(plan.date).toLocaleDateString(undefined, { month: "short", day: "numeric", year: "numeric" })}</p>
        </div>
        <div style={{
        ...
        <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, margin: "5px 2px 0", textAlign: "center" }}>Move this plan to Completed Plans. You can still review it later.</p>
        <div style={{ textAlign: "center", marginTop: 12 }}>
          <span style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, fontWeight: 700, letterSpacing: .45, textTransform: "uppercase" }}>Plan total</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.18fr 1fr", gap: 8, marginTop: 9 }}>
          <div style={{ background: GOLD_GRADIENT, borderRadius: 16, padding: "14px 13px", color: "#fff", boxShadow: SHADOW_BTN, textAlign: "center" }}>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, margin: 0, opacity: 0.78, textTransform: "uppercase", fontWeight: 800, letterSpacing: 0.3 }}>Remaining</p>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, margin: "5px 0 0", opacity: 0.72 }}>of {formatMoney(totalBudget, currency)}</p>
          </div>
          <div style={{ background: INPUT_BG, borderRadius: 16, padding: "14px 13px", textAlign: "center" }}>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, margin: 0, color: MUTED, textTransform: "uppercase", fontWeight: 800, letterSpacing: 0.3 }}>Spent</p>
        ...
        <div style={{ marginTop: 13 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
            <span style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED }}>Plan progress</span>
          </div>
      ...
      {resourcePrompt && (
        <div className="pr-rise" style={{ marginTop: 12, background: ACTIVE_TINT, border: `1px solid ${LINE}`, borderRadius: 16, padding: "12px 13px" }}>
          <p style={{ margin: 0, fontFamily: "Inter, sans-serif", fontSize: 12, color: GOLD, fontWeight: 800, letterSpacing: .7 }}>A QUICK TIP FOR YOUR PLAN</p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
        {displayCategories.map((c, index) => {
          ...
          // Preserve the percentage the user actually saved in the rule.
          // Do not recompute it from rounded money amounts: independently
          // rounding those derived percentages can make a valid 100% rule
          // display as 99%, 101%, 102%, etc.
          const rawPlanPct = Number(c.pct);
          const planPct = Number.isFinite(rawPlanPct)
            ? (Number.isInteger(rawPlanPct) ? String(rawPlanPct) : rawPlanPct.toFixed(1).replace(/\.0$/, ""))
            : "0";
          return (
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6, marginTop: 3 }}>
                    ...
                    <span style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: over ? CORAL : GOLD, fontWeight: 700, flexShrink: 0 }}>
          ...
          <div style={{ background: PAPER_DIM, border: `1px solid ${LINE}`, borderRadius: R_MD, boxShadow: "none", overflow: "hidden" }}>
            ...
            <div style={{ borderTop: `1px solid ${LINE}` }}>
              <button onClick={() => { window.location.href = "mailto:support@pocketrule.com?subject=PocketRule%20Support%20or%20Feature%20Request"; }} style={{ width: "100%", background: "none", border: "none", cursor: "pointer", padding: "13px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}><Mail size={16} color={INK} /><div style={{ textAlign: "left" }}><span style={{ display: "block", fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: 13.5, color: INK }}>Contact Us / Request a Feature</span><span style={{ display: "block", fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED, marginTop: 2 }}>support@pocketrule.com</span></div></div>
                <ChevronRight size={16} color={MUTED} />
              </button>
            </div>
          </div>
  ...
  return (
    <div style={{ paddingBottom: 24 }}>
      ...
      <div style={{ padding: "0 20px" }}>
        ...
        <div style={{ marginTop: 13, background: PAPER_DIM, border: `1px solid ${LINE}`, borderRadius: 15, padding: 13 }}><div style={{ display: "flex", justifyContent: "space-between", marginBottom: 7 }}><span style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: MUTED }}>Plan progress</span></div><div style={{ height: 7, background: LINE, borderRadius: 999, overflow: "hidden" }}><div style={{ width: `${progress}%`, height: "100%", background: GOLD, borderRadius: 999 }} /></div></div>
